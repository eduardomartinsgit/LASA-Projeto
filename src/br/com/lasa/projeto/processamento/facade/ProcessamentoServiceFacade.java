...
public class ProcessamentoServiceFacade {
	...
	public void criarArquivoProcessados(List<VendaVO> listaProcessados) throws IOException {
		...
		PrintWriter arquivo = new PrintWriter(new File("C:\\PROCESSADOS\\VENDAS_PROCESSADAS_" + formatador.format(dataAtual) + ".txt"));
